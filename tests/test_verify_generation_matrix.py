...
class ProgressionReplayTests(unittest.TestCase):
    def test_enhanced_replay_does_not_block_c_behind_unbuildable_a(self):
    ...
    def test_legacy_tutorial_gap_blocks_later_tutorial_and_second_page(self):
        ...
        for target in ("Complete O", "Complete IVY"):
            spoiler = f"""Playthrough:
0: {{
  Bender Access
  Merger2 Access
  Reflection Access
  Progressive World Access
}}
1: {{
  {target}: Rotation Access
}}
2: {{
  Victory: Victory
}}
...
class IdentityExtractionTests(unittest.TestCase):
    def test_extracts_layout_order_digest_and_canonical_sets(self):
        ...
        self.assertEqual(identity.implementation_version, "1.5.1")
...
slot = {"level_order": ["cat", "owl"], "layout_digest": "d" * 64,
        "implementation_version": "1.5.1", "level_set": "core_campaign",
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(
                ...
                },
                {
                    ...
                    "requested_implementation_version": "1.5.1",
                    ...
                    "generated_implementation_version": "1.5.1",
