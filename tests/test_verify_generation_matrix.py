...
class IdentityExtractionTests(unittest.TestCase):
    def test_extracts_layout_order_digest_and_canonical_sets(self):
        ...
        self.assertEqual(identity.implementation_version, "1.4.1")
...
slot = {"level_order": ["cat", "owl"], "layout_digest": "d" * 64,
        "implementation_version": "1.4.1", "level_set": "core_campaign",
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(
                ...
                },
                {
                    ...
                    "requested_implementation_version": "1.4.1",
                    ...
                    "generated_implementation_version": "1.4.1",
