...
Version **[1.5.0 is a tester prerelease](https://github.com/Akamarus/word-factori-archipelago/releases/tag/v1.5.0)**, not a stable release. It includes Recipe Journal checks, optional Type-a-Word orders, optional progressive machines and Universal Tracker reconstruction fixes. Use Archipelago 0.6.7, the matching APWorld/client/native patch, a **new room**, and a **fresh empty mod save**. Keep old saves and the original-game backup; do not reuse their progress for the new room.
...
| `type_a_word_words` | `[]` | Up to 200 entries, each 2–12 ASCII letters; enough distinct words for the count. |
...
1. Download and extract **[word-factori-archipelago-1.5.0.zip](https://github.com/Akamarus/word-factori-archipelago/releases/download/v1.5.0/word-factori-archipelago-1.5.0.zip)**, the single player package. Do not use GitHub's automatic source-code archives.
...
See the bundled `docs/linux-proton.md` or [full Linux guide](https://github.com/Akamarus/word-factori-archipelago/blob/v1.5.0/docs/linux-proton.md) for manual paths, verify, restore, uninstall, and recovery. Automated Ubuntu tests pass, but a **real Linux/Proton playthrough remains unverified**.
...
- Tracker reconstruction uses the room's saved layout, goal, recipes, word orders and progressive settings. Install the matching 1.5.0 APWorld in the tracker environment; a connected tracker playthrough remains pending.
