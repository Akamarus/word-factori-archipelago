...
This build remains experimental until the complete live client matrix is recorded. Only the bundled digest-verified `core_campaign` and `discovery_labs` manifests can be selected; arbitrary Workshop packs are not imported.
